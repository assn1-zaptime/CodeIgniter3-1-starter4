...
class TaskTest extends TestCase
  {
    ...
    public function testSetAccCode (){
        $expected = "acc-9";
        $this->Accessory->setAccCode($expected);
    ...
    public function testSetCatCode (){
        $expected = "cat-1";
        $this->Accessory->setCatCode($expected);
    ...
    public function testSetPretty (){
        $expected = 80;
        $this->Accessory->setPretty($expected);
    ...
    public function testSetCool(){
        $expected = 70;
        $this->Accessory->setCool($expected);
        //$this->Accessory->cool = $expected;
        $this->assertEquals($expected,$this->Accessory->cool);
    }
    
    public function testSetWacky(){
        $expected =0;
        $this->Accessory->setWacky($expected);
        //$this->Accessory->wacky = $expected;
        $this->assertEquals($expected,$this->Accessory->wacky);
    }
    
    public function testWackyNull(){
        try{
            $this->Accessory->setWacky("");
        } catch (Exception $e) {
            $this->assertEquals("Wacky must have a value",$e->getMessage());
        }
    }
  }